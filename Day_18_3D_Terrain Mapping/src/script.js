...
// Evaluate
// Create an evaluator for CSG operations
const evaluator = new Evaluator()

// Perform a subtraction operation between the boardFill and boardHole brushes
const board = evaluator.evaluate(boardFill, boardHole, SUBTRACTION)

// Clear any existing groups in the geometry
